...
| Knikpunt ||||
 ...
 $ q_z \left( x\right) : \sum\limits_{k}\sum\limits_{i}^{n} \left\langle a_i - b_k \right\rangle^{0} F_{v,k}  \left\langle x - a_{i} \right\rangle^{- 1}\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta_{i - 1} \right)  \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle a_i - b_k \right\rangle^{0}F_{h,k}  \left\langle x - a_{i} \right\rangle^{- 1}\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta_{i - 1} \right) \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle a_i - b_k \right\rangle^{0} q_{v,k} \left( {\left\langle x - a_{i} \right\rangle}^{0} + \left\langle x - a_{i} \right\rangle^{- 1}\left( a_{i} - b \right) \right)\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta_{i - 1} \right) \right)$ <br> $ \qquad + \sum\limits_{k}\sum\limits_{i}^n\left\langle a_i - b_k \right\rangle^{0} q_{h,k} \left( {\left\langle x - a_{i} \right\rangle}^{0} + \left\langle x - a_{i} \right\rangle^{- 1}\left( a_{i} - b_k \right) \right)\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta_{i - 1} \right) \right) $ <br> met $n$ het aantal knikken met voor elke knik $i$ een bijbehorende hoek $\theta_i$ en voor elke $F_k$ en $q_k$ inclusing $H$, $V$ en $R$.
