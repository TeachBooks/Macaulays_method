...
| Aansluitpunt | $q_z\left(x\right) : V^{b} \left\langle x - \bar x_1  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - V^{b} \left\langle x - \bar x  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $ \qquad + H^{b}\left\langle x - \bar x_1 \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) - H^{b}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$ <br> $\qquad +T^{b} \left\langle x - \bar x_1 \right\rangle^{- 2}  - T^{b} \left\langle x - \bar x \right\rangle^{- 2} $ <br> $q_x\left(x\right) : -V^{b} \left\langle x - \bar x_1  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + V^{b} \left\langle x - \bar x  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$<br>$\qquad + H^{b}\left\langle x - \bar x_1 \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)  - H^{b}\left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$  <br> met $\bar x_1$ de coordinaat van de eerste keer dat langs de vertakking is gegaan| $\varphi\left( \bar x \right) = \varphi \left( \bar x_1 \right)$ <br>$u_v\left( \bar x \right) = u_v \left( \bar x_1 \right)$ <br>$ u_h\left( \bar x \right) = u_h \left( \bar x_1 \right)$ | $H^{b}$, $V^{b}$, $T^{b}$ ||
| Sprongpunt naar andere vertakking | $q_z\left(x\right) : V^{b} \left\langle x - \bar x_1  \right\rangle^{- 1}\cos\left( \theta \left( \bar x_1 \right) \right) - V^{b} \left\langle x - \bar x_2  \right\rangle^{- 1}\cos\left( \theta \left( \bar x_2 \right) \right)$ <br> $ \qquad + H^{b}\left\langle x - \bar x_1 \right\rangle^{- 1}\sin\left( \theta \left( \bar x_1 \right) \right) - H^{b}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x_2 \right) \right)$ <br> $\qquad +T^{b} \left\langle x - \bar x_1 \right\rangle^{- 2}  - T^{b} \left\langle x - \bar x_2 \right\rangle^{- 2}$ <br> $ \qquad + EI \varphi^{b} \left\langle x - \bar x_2 \right\rangle^{- 3} + EI u_z^{b} \left\langle x - \bar x_3 \right\rangle^{- 4}$ <br> $q_x\left(x\right) : -V^{b} \left\langle x - \bar x_1  \right\rangle^{- 1}\sin\left( \theta \left( \bar x_1 \right) \right) + V^{b} \left\langle x - \bar x_2  \right\rangle^{- 1}\sin\left( \theta \left( \bar x_2 \right) \right)$<br>$\qquad + H^{b}\left\langle x - \bar x_1 \right\rangle^{- 1}\cos\left( \theta \left( \bar x_1 \right) \right)  - H^{b}\left\langle x - \bar x_2 \right\rangle^{- 1}\cos\left( \theta \left( \bar x_2 \right) \right)$ <br> $\qquad EI u_x^{b} \left\langle x - \bar x_2 \right\rangle^{- 2}$ <br> met $\bar x_1$ en $\bar x_2$ de coordinaat van de respectievelijk eerste en tweede keer dat langs de vertakking is gegaan en $\bar x_\text{sprong}$ de coordinaat voor de sprong.| $N\left(\bar x_\text{sprong}^{+}\right) = 0$ <br> $V\left(\bar x_\text{sprong}^{+}\right) = 0$ <br> $M\left(\bar x_\text{sprong}^{+}\right) = 0$ <br> $\varphi\left( \bar x_1 \right) = \varphi \left( \bar x_2 \right)$ <br> $u_v\left( \bar x_1 \right) = u_v \left( \bar x_2 \right)$ <br> $u_h\left( \bar x_1 \right) = u_h \left( \bar x_2 \right)$ | $H^{b}$, $V^{b}$, $T^{b}$<br> $u_z^{b}$, $u_x^{b}$, $\varphi^{b}$ <br> met $\bar x_1$ en $\bar x_2$ de coordinaat van de respectievelijk eerste en tweede keer dat langs de vertakking is gegaan en $\bar x_\text{sprong}$ de coordinaat voor de sprong.||
| Knikpunt | $ q_z \left( x\right) : \sum\limits_{k}\sum\limits_{i}^{n} \left\langle \bar x_i - \bar x_{F_j} \right\rangle^{0} F_{v,j}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \cos\left( \theta \left( \bar x_i \right) \right) - \cos\left( \theta \left( \bar x_i^- \right) \right)  \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle \bar x_i - \bar x_{F_j} \right\rangle^{0}F_{h,j}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta \left( \bar x^- \right) \right) \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle \bar x_i - \bar x_{q_j} \right\rangle^{0} q_{v,j} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_i \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_j} \right) \right)\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta \left( \bar x^- \right) \right) \right)$ <br> $ \qquad + \sum\limits_{k}\sum\limits_{i}^n\left\langle \bar x_i - \bar x_{q_j} \right\rangle^{0} q_{h,j} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_u \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_j} \right) \right)\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta \left( \bar x^- \right) \right) \right) $ <br> $ q_x \left( x\right) : \sum\limits_{k}\sum\limits_{i}^{n} \left(-\left\langle \bar x_i - \bar x_{F_j} \right\rangle^{0} F_{v,j}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \sin\left( \theta \left( \bar x_i \right) \right) - \sin\left( \theta \left( \bar x_i^- \right) \right)  \right) \right)$ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle \bar x_i - \bar x_{F_j} \right\rangle^{0}F_{h,j}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta \left( \bar x^- \right) \right) \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left( -\left\langle \bar x_i - \bar x_{q_j} \right\rangle^{0} q_{v,j} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_i \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_j} \right) \right)\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta \left( \bar x^- \right) \right) \right) \right)$ <br> $ \qquad + \sum\limits_{k}\sum\limits_{i}^n\left\langle \bar x_i - \bar x_{q_j} \right\rangle^{0} q_{h,j} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_u \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_j} \right) \right)\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta \left( \bar x^- \right) \right) \right) $ <br> NOG TOEVOEGEN VERPLAATSINGEN <br> met $n$ het aantal knikken met voor elke knik $i$ een bijbehorende hoek $\theta_i$ en voor elke $F_j$ en $q_j$ inclusing $H$, $V$ en $R$.|||
