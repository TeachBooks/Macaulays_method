...
| Aansluitpunt | $q_z\left(x\right) : V^{\text{sprong}} \left\langle x - \bar x_1  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - V^{\text{sprong}} \left\langle x - \bar x  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $ \qquad + H^{\text{sprong}}\left\langle x - \bar x_1 \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) - H^{\text{sprong}}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$ <br> $\qquad +T^{\text{sprong}} \left\langle x - \bar x_1 \right\rangle^{- 2}  - T^{\text{sprong}} \left\langle x - \bar x \right\rangle^{- 2} $ <br> $q_x\left(x\right) : -V^{\text{sprong}} \left\langle x - \bar x_1  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + V^{\text{sprong}} \left\langle x - \bar x  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$<br>$\qquad + H^{\text{sprong}}\left\langle x - \bar x_1 \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)  - H^{\text{sprong}}\left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$  <br> met $\bar x_1$ de coordinaat van de eerste keer dat langs de vertakking is gegaan| $\varphi\left( \bar x \right) = \varphi \left( \bar x_1 \right)$ <br>$u_v\left( \bar x \right) = u_v \left( \bar x_1 \right)$ <br>$ u_h\left( \bar x \right) = u_h \left( \bar x_1 \right)$ | $H^{\text{sprong}}$, $V^{\text{sprong}}$, $T^{\text{sprong}}$ ||
| Sprongpunt naar andere vertakking | $q_z\left(x\right) : V^{\text{sprong}} \left\langle x - \bar x_1  \right\rangle^{- 1}\cos\left( \theta \left( \bar x_1 \right) \right) - V^{\text{sprong}} \left\langle x - \bar x_2  \right\rangle^{- 1}\cos\left( \theta \left( \bar x_2 \right) \right)$ <br> $ \qquad + H^{\text{sprong}}\left\langle x - \bar x_1 \right\rangle^{- 1}\sin\left( \theta \left( \bar x_1 \right) \right) - H^{\text{sprong}}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x_2 \right) \right)$ <br> $\qquad +T^{\text{sprong}} \left\langle x - \bar x_1 \right\rangle^{- 2}  - T^{\text{sprong}} \left\langle x - \bar x_2 \right\rangle^{- 2}$ <br> $ \qquad + EI \varphi^{\text{sprong}} \left\langle x - \bar x_2 \right\rangle^{- 3} + EI u_z^{\text{sprong}} \left\langle x - \bar x_3 \right\rangle^{- 4}$ <br> $q_x\left(x\right) : -V^{\text{sprong}} \left\langle x - \bar x_1  \right\rangle^{- 1}\sin\left( \theta \left( \bar x_1 \right) \right) + V^{\text{sprong}} \left\langle x - \bar x_2  \right\rangle^{- 1}\sin\left( \theta \left( \bar x_2 \right) \right)$<br>$\qquad + H^{\text{sprong}}\left\langle x - \bar x_1 \right\rangle^{- 1}\cos\left( \theta \left( \bar x_1 \right) \right)  - H^{\text{sprong}}\left\langle x - \bar x_2 \right\rangle^{- 1}\cos\left( \theta \left( \bar x_2 \right) \right)$ <br> $\qquad EI u_x^{\text{sprong}} \left\langle x - \bar x_2 \right\rangle^{- 2}$ <br> met $\bar x_1$ en $\bar x_2$ de coordinaat van de respectievelijk eerste en tweede keer dat langs de vertakking is gegaan en $\bar x_\text{sprong}$ de coordinaat voor de sprong.| $N\left(\bar x_\text{sprong}^{+}\right) = 0$ <br> $V\left(\bar x_\text{sprong}^{+}\right) = 0$ <br> $M\left(\bar x_\text{sprong}^{+}\right) = 0$ <br> $\varphi\left( \bar x_1 \right) = \varphi \left( \bar x_2 \right)$ <br> $u_v\left( \bar x_1 \right) = u_v \left( \bar x_2 \right)$ <br> $u_h\left( \bar x_1 \right) = u_h \left( \bar x_2 \right)$ <br> met $\bar x_1$ en $\bar x_2$ de coordinaat van de respectievelijk eerste en tweede keer dat langs de vertakking is gegaan en $\bar x_\text{sprong}$ de coordinaat voor de sprong.| $H^{\text{sprong}}$, $V^{\text{sprong}}$, $T^{\text{sprong}}$<br> $u_z^{\text{sprong}}$, $u_x^{\text{sprong}}$, $\varphi^{\text{sprong}}$ ||
