...
| Scharnierverbinding | $q_z\left(x\right) : EI \varphi \left\langle x - \bar x \right\rangle^{- 3}$ | $M \left(\bar x\right) = 0$| $\varphi_S$ |
| Schuifverbinding | $q_z\left(x\right): EI u_z \left\langle x - \bar x \right\rangle^{- 4}$ | $V \left(\bar x\right) = 0$| $u_z$ |
| Telescoopverbinding | $q_x\left(x\right) :EA u_x \left\langle x - \bar x \right\rangle^{- 2}$ | $N \left(\bar x\right) = 0$| $u_x$ |
...
| Aansluitpunt | $q_z\left(x\right) : V^{ik} \left\langle x - a_k  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - V^{ik} \left\langle x - \bar x  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $ \qquad + H^{ik}\left\langle x - a_k \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) - H^{ik}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$ <br> $\qquad +T^{ik} \left\langle x - a_k \right\rangle^{- 2}  - T^{ik} \left\langle x - \bar x \right\rangle^{- 2} $ <br> $q_x\left(x\right) : -V^{ik} \left\langle x - a_k  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + V^{ik} \left\langle x - \bar x  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$<br>$\qquad + H^{ik}\left\langle x - a_k \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)  - H^{ik}\left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ | $\varphi\left( \bar x \right) = \varphi \left( a_k \right)$ <br>$u_v\left( \bar x \right) = u_v \left( a_k \right)$ <br>$ u_h\left( \bar x \right) = u_h \left( a_k \right)$ | $H^{ik}$, $V^{ik}$, $T^{ik}$ ||
| Sprongpunt naar andere vertakking | $q_z\left(x\right) : V^{ik} \left\langle x - a_k  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - V^{ik} \left\langle x - \bar x  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $ \qquad + H^{ik}\left\langle x - a_k \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) - H^{ik}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$ <br> $\qquad +T^{ik} \left\langle x - a_k \right\rangle^{- 2}  - T^{ik} \left\langle x - \bar x \right\rangle^{- 2}$ <br> $ \qquad + EI \varphi^{ik} \left\langle x - a_k \right\rangle^{- 3} + EI u_z^{ik} \left\langle x - a_k \right\rangle^{- 4}$ <br> $q_x\left(x\right) : -V^{ik} \left\langle x - a_k  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + V^{ik} \left\langle x - \bar x  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$<br>$\qquad + H^{ik}\left\langle x - a_k \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)  - H^{ik}\left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $\qquad EI u_x^{ik} \left\langle x - a_k \right\rangle^{- 2}$ | $N\left(\bar x^{+}\right) = 0$ <br> $V\left(\bar x^{+}\right) = 0$ <br> $M\left(\bar x^{+}\right) = 0$ <br> $\varphi\left( \bar x \right) = \varphi \left( a_k \right)$ <br> $u_v\left( \bar x \right) = u_v \left( a_k \right)$ <br> $u_h\left( \bar x \right) = u_h \left( a_k \right)$ | $H^{IK}$, $V^{IK}$, $T^{IK}$<br> $u_z^{ik}$, $u_x^{ik}$, $\varphi^{ik}$ ||
| Knikpunt ||||
```
````
...
| Scharnierende oplegging | $q_z\left(x\right) : R_{h} \left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + R_{v} \left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$<br> $q_x\left(x\right) : R_{h} \left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - R_{v} \left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) $  |$u_v \left(\bar x\right) = 0$ <br> $u_h \left(\bar x\right) = 0$ | $R_h$, $R_v$ |
| Inklemming | $q_z\left(x\right) : R_{h} \left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + R_{v} \left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) + T \left\langle x - \bar x \right\rangle^{- 2}$<br> $q_x\left(x\right) : R_{h} \left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - R_{v} \left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) $ | $\varphi \left( \bar x \right) = 0$ <br> $u_v \left(\bar x\right) = 0$ <br> $u_h \left(\bar x\right) = 0$ | $R_h$, $R_v$, $T$ |
| Aansluitpunt | $q_z\left(x\right) : V^{b} \left\langle x - \bar x_b  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - V^{b} \left\langle x - \bar x  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $ \qquad + H^{b}\left\langle x - \bar x_k \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) - H^{b}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$ <br> $\qquad +T^{b} \left\langle x - \bar x_k \right\rangle^{- 2}  - T^{b} \left\langle x - \bar x \right\rangle^{- 2} $ <br> $q_x\left(x\right) : -V^{b} \left\langle x - \bar x_k  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + V^{b} \left\langle x - \bar x  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$<br>$\qquad + H^{b}\left\langle x - \bar x_k \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)  - H^{b}\left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$  <br> met $\bar x_b$ de coordinaat van de eerste keer dat langs de vertakking is gegaan| $\varphi\left( \bar x \right) = \varphi \left( \bar x_k \right)$ <br>$u_v\left( \bar x \right) = u_v \left( \bar x_k \right)$ <br>$ u_h\left( \bar x \right) = u_h \left( \bar x_k \right)$ | $H^{b}$, $V^{b}$, $T^{b}$ ||
| Sprongpunt naar andere vertakking | $q_z\left(x\right) : V^{b} \left\langle x - \bar x_k  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right) - V^{b} \left\langle x - \bar x  \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $ \qquad + H^{b}\left\langle x - \bar x_k \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) - H^{b}\left\langle x - \bar x \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$ <br> $\qquad +T^{b} \left\langle x - \bar x_k \right\rangle^{- 2}  - T^{b} \left\langle x - \bar x \right\rangle^{- 2}$ <br> $ \qquad + EI \varphi^{b} \left\langle x - \bar x_k \right\rangle^{- 3} + EI u_z^{b} \left\langle x - \bar x_k \right\rangle^{- 4}$ <br> $q_x\left(x\right) : -V^{b} \left\langle x - \bar x_k  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right) + V^{b} \left\langle x - \bar x  \right\rangle^{- 1}\sin\left( \theta \left( \bar x \right) \right)$<br>$\qquad + H^{b}\left\langle x - \bar x_k \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)  - H^{b}\left\langle x - \bar x \right\rangle^{- 1}\cos\left( \theta \left( \bar x \right) \right)$ <br> $\qquad EI u_x^{b} \left\langle x - \bar x_k \right\rangle^{- 2}$ <br> met $\bar x_b$ de coordinaat van de eerste keer dat langs de vertakking is gegaan| $N\left(\bar x^{+}\right) = 0$ <br> $V\left(\bar x^{+}\right) = 0$ <br> $M\left(\bar x^{+}\right) = 0$ <br> $\varphi\left( \bar x \right) = \varphi \left( \bar x_k \right)$ <br> $u_v\left( \bar x \right) = u_v \left( \bar x_k \right)$ <br> $u_h\left( \bar x \right) = u_h \left( \bar x_k \right)$ | $H^{b}$, $V^{b}$, $T^{b}$<br> $u_z^{b}$, $u_x^{b}$, $\varphi^{b}$ ||
| Knikpunt | $ q_z \left( x\right) : \sum\limits_{k}\sum\limits_{i}^{n} \left\langle \bar x_i - \bar x_{F_k} \right\rangle^{0} F_{v,k}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \cos\left( \theta \left( \bar x_i \right) \right) - \cos\left( \theta \left( \bar x_i^- \right) \right)  \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle \bar x_i - \bar x_{F_k} \right\rangle^{0}F_{h,k}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta \left( \bar x^- \right) \right) \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle \bar x_i - \bar x_{q_k} \right\rangle^{0} q_{v,k} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_i \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_k} \right) \right)\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta \left( \bar x^- \right) \right) \right)$ <br> $ \qquad + \sum\limits_{k}\sum\limits_{i}^n\left\langle \bar x_i - \bar x_{q_k} \right\rangle^{0} q_{h,k} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_u \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_k} \right) \right)\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta \left( \bar x^- \right) \right) \right) $ <br> $ q_x \left( x\right) : \sum\limits_{k}\sum\limits_{i}^{n} \left(-\left\langle \bar x_i - \bar x_{F_k} \right\rangle^{0} F_{v,k}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \sin\left( \theta \left( \bar x_i \right) \right) - \sin\left( \theta \left( \bar x_i^- \right) \right)  \right) \right)$ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left\langle \bar x_i - \bar x_{F_k} \right\rangle^{0}F_{h,k}  \left\langle x - \bar x_i \right\rangle^{- 1}\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta \left( \bar x^- \right) \right) \right) $ <br> $\qquad + \sum\limits_{k}\sum\limits_{i}^n \left( -\left\langle \bar x_i - \bar x_{q_k} \right\rangle^{0} q_{v,k} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_i \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_k} \right) \right)\left( \sin\left( \theta \left( \bar x \right) \right) - \sin\left( \theta \left( \bar x^- \right) \right) \right) \right)$ <br> $ \qquad + \sum\limits_{k}\sum\limits_{i}^n\left\langle \bar x_i - \bar x_{q_k} \right\rangle^{0} q_{h,k} \left( {\left\langle x - \bar x_i \right\rangle}^{0} + \left\langle x - \bar x_u \right\rangle^{- 1}\left( \bar x_i - \bar x_{q_k} \right) \right)\left( \cos\left( \theta \left( \bar x \right) \right) - \cos\left( \theta \left( \bar x^- \right) \right) \right) $ <br> met $n$ het aantal knikken met voor elke knik $i$ een bijbehorende hoek $\theta_i$ en voor elke $F_k$ en $q_k$ inclusing $H$, $V$ en $R$.|||
